    ...
    try {
      ...
      if (data.success && data.tour) {
        ...
        setFormData({
          ...
          totalSeats: tour.totalSeats.toString(),
          ...
          itinerary: typeof tour.itinerary === "string" ? tour.itinerary : JSON.stringify(tour.itinerary, null, 2),
          hotelStars: tour.hotelStars?.toString() || "",
          ...
          earlyBirdDeadline: tour.earlyBirdDeadline ? tour.earlyBirdDeadline.split("T")[0] : "",
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-ivory">
        <div className="text-center">
          ...
          <p className="text-sm text-charcoal/60">Loading tour...</p>
        </div>
      </div>
    );
  }
      ...
      <header className="border-b border-charcoal/5 bg-white">
        <div className="mx-auto max-w-4xl px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-display text-2xl text-charcoal">Edit Tour</h1>
